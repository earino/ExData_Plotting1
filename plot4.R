##
## Generate Plot4 for the Coursera Exploratory Data Analysis class
## Peer Assessments / Course Project 1
##
## This code plots 4 charts in a single graphics context. The bottom of the axis
## is the Date range. The top left is Global Active Power, top right is Voltage
## bottom left, Energy sub meetering, bottom right Global reactive power.
##
...
plot(relevant_data$DateTime, relevant_data$Global_active_power, type="l", xlab="", ylab="Global Active Power")

plot(relevant_data$DateTime, relevant_data$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), cex=0.95, lty=1, col=c("black", "red", "blue"), box.lwd = 0,box.col = "white")

plot(relevant_data$DateTime, relevant_data$Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power")
