##
## Generate Plot2 for the Coursera Exploratory Data Analysis class
## Peer Assessments / Course Project 1
##
## This code generates a line plot of Global Active Power in kilowatts, against
## time on the X axis.
##
...
plot(relevant_data$DateTime, relevant_data$Global_active_power, 
